...
/**
 * Fetch pending friend requests sent TO currentUserId (friend_2 = currentUserId, status = pending).
 * Joins the requester's profile data.
 */
 ...
 * Returns profiles of the other party in each friendship row.
 */
