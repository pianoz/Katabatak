...
export function CreatureDisplay({ creature, isActiveAttacker, isFlashing }: CreatureDisplayProps) {
  if (!creature) {
    return null
  }
  ...
  return (
    <div
      className={[
        "w-1/5 min-w-30 max-w-50 border p-3 flex flex-col gap-2 transition-all duration-200",
        defeated
